...
用法：
    python -m cirtorch.scripts.build_db --image_dir <图像目录> --save_dir <保存目录>
"""
...
def main():
    parser = argparse.ArgumentParser(description='构建 SkNN 加密图像检索数据库')
