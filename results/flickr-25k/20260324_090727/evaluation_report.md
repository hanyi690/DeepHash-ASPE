...
| 唯一性 | 0.7700 | 不同哈希码的区分度 |
| 平均汉明距离 | 0.4968 | 理想值接近 bit/2 |
| 稀疏性 | 0.0000 | 哈希码的非零比例 |
...
|----------|----------|----------|------|
| i→t | 0.720986 | 0.719892 | 1.09e-03 |
| t→i | 0.757472 | 0.756533 | 9.39e-04 |
...
本次评估使用 64 bits 哈希码，在 Flickr-25K 数据集上达到 **0.7392** 的平均 mAP。
